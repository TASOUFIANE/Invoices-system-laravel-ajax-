			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='chart-morris') }}">Invoices List</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-flot') }}">UnPayed Invoices</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-chartjs') }}">Half Payed Invoices</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-echart') }}">Payed Invoices</a></li>
						</ul>
					</li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='mail-compose') }}">Users Permissions</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='profile') }}">Add Section</a></li>
